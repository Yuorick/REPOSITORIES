...
// Класс описывает характеристики детонатора

// СЛУЧАЙ ПЕРСПЕКТИВНОГО ВУ БАРЬЕР кал 76 мм
// marrDetonatorParams[0] - дискрет установки времени срабатывания
// marrDetonatorParams[1] - коэффицент нарастания ошибки срабатывания при полетном времени


// СЛУЧАЙ штатного АР51-ЛМ
// marrDetonatorParams[0] - радиус чуствительности
class TDetonator
{
public:
