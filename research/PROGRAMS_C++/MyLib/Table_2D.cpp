...
TTable_2D :: TTable_2D( double *parrArg, TTable_1D *pArrTable_1D, const int NumCols)

 {
	...
	// парам констр 2
 //	parrArgTab1 [ NumColsTab1  ] - массив аргументов таблицы 1 (”«ѕ при фиксированной дальности)
 //      дл€ морской цели это целочисленный массив от 1 до к-ва попаданий при которогм веро€тность поражени€ равна 1
 //	parrArgTab2 [ NumColsTab2  ] - массив аргументов таблицы 2 . Ёто дальности, прикоторых насчитаны ”«ѕ. ¬ысоты фиксвированы
 //      дл€ морской цели это массив дальностей при которых насчитанны ”«ѕ
 // parrVal[NumColsTab1 * NumColsTab2 ] - массив веро€тностей
