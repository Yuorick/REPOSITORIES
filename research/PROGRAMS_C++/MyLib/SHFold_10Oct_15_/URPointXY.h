...
public:
	...
	// virtual ~ TURPointXY() ;
		void ShowMe()	;
		static double calcVectS(const TURPointXY P1,const TURPointXY P2);

		static double dist(const TURPointXY P1,const TURPointXY P2);
...
static int PutPointsArrayToCsvFile(wchar_t*FileName,TURPointXY * pPntArr
	 ,const int lenArray);
