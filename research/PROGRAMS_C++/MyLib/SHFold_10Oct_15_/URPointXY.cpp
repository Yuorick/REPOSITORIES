...
double TURPointXY::calcVectS(const TURPointXY P1,const TURPointXY P2)
{
	return (P1.X * P2.Y - P1.Y* P2.X)/2;
}
double  TURPointXY::dist(const TURPointXY P1,const TURPointXY P2)
{
...
//---------------------------------------------------------------------------
 ...
 double  TURPointXY::calcAng(const  TURPointXY P1,const  TURPointXY P2)
 {
	 return acos( (P1.X * P2.X + P1.Y * P2.Y )/ P1.Norm()/ P2.Norm() );
 }

 double  TURPointXY::calcCosAng(const  TURPointXY P1,const  TURPointXY P2)
 {
