...
// количество излучателей в фасете
 ...
 // длина волны
 double	 mLambda ;
 //  скз внутр. шума излучателя
 double mSigEmitNoise ;
	//  скз шума КУ излуателя( 1 + delta)
	// ЭТО комплексный шум с дисперсией  mSigEmitAmplFact*mSigEmitAmplFact
	// он должен добавляться к внутреннуму шуму антенны
	// диспесия суммарного шума в фасете будет равна
	// mSigEmitNoise*mSigEmitNoise  * m_n +  mSigEmitAmplFact  * mSigEmitAmplFact *  A * A * m_n
	// A - модуль сигнала принимаенмого излучателем
