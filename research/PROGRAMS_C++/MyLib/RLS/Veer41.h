...
//--------------------------------------------------------------------------
int  _fastcall solv3(TComp *pSDifZv,TComp *pcmpSZv , TComp *pZTarg, TComp *pZAnt, double *palfTrg, double *palfAnp ) ;

int _fastcall calc_vectG_and_mtrxH_solv3 (TComp *pSDifZv, TComp *pcmpSZv
