...
TURPointZ::TURPointZ()
 ...
 // оператор присв
TURPointZ &TURPointZ::operator=(const TURPointZ &p2)
{
     X = p2.X;
	 Y=  p2.Y ;
	 Z = p2.Z ;
...
void   TURPointZ::LinearTransformation(const double  valAng , const TURPointXY pntSdvig,const double valRastigenie )
{
