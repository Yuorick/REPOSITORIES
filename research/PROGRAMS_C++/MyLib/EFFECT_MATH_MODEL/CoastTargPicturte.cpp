...
// arrElK[4] - коррел матрица рассеяния точки падения
// VAlPsi - курсовой угол скорости снаряда в точке встречи
		 ...
		 , double *arrMtrxCorrSyst, TURFigure *pFigure, const double VAlTargCourse0, const double VAlPsi)
{
 ...
 ///
	...
	// 2. формирование эллипса флукт ошибки
	...
	///
	 ...
	 // 3. формирование эллипса сист. ошибки
	...
	// 4. формирование эллипса сувммарнгой  ошибки
