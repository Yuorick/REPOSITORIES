...
//5. ПОЛИГОН С14_1 (C13 верткалльный)
...
///
//6. ПОЛИГОН С14 (C13 верткалльный)
...
double arrS0_NOSE[3] = {0.,0., 0.}; // координаты начала СКП
