...
// конструктор копирования
 ...
 //--------------------------------------------------
 // инициализация привода по конкретной цели
 void TDriverMech :: init (	 const double TDr  // текущее время привязки иныормации
							,const double VAlEstEps // оценка(измерение) угла Eps
							,const double VAlEstBet  // оценка(измерение) угла Bet
							,const double VAlRealEps // истинный угол Eps
							,const double VAlRealBet  // истинный угол Bet
   ...
   if ( valT < mTDr )
	{
	 ...
	 mDelEps = 0.;//getGauss(0, mSigEps );// ошибка по  Eps
	 mDelBet = 0.;//getGauss(0, mSigBet ); // ошибка по Bet
