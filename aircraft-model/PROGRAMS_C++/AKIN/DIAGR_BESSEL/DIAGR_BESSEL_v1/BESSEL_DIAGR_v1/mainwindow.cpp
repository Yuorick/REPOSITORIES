    ...
    ui(new Ui::MainWindow)
{
    ...
    {
    case 0:
        ui->doubleSpinBox_4->setPrefix(QString("Радиус ант:"));
        ui->doubleSpinBox_4->setValue(9);
        break;

    case 1:
        ui->doubleSpinBox_4->setPrefix(QString("Шаг решетки:"));
        ui->doubleSpinBox_4->setValue(2.4);
        break;
...
void MainWindow:: inputData()
{
    ...
    mr = ui->doubleSpinBox_4->value() * 0.01;
    ...
    {
    case 0:
        mOrbitalAnt = QOrbitalAnt (mQuant,  ma, mr) ;
        mpSubWaterAnt = &mOrbitalAnt;
        break;

    case 1:
        mMtrxAnt = QMtrxAnt (mQuant,  ma, mr) ;
        mpSubWaterAnt = &mMtrxAnt;
    }
...
return;*/
   ...
   wcscpy(&pwcharrColNames2[iLenName   ],  L"Ant_R");
      ...
      mpSubWaterAnt->collectData_forDiagrGraph_e(mlamb, mScan_q0, mScan_e0 , QUantRows
     ...
     // оси  координат
      ...
      TComp Comp = mpSubWaterAnt->calcSumNormalizedDiagr(mlamb,mScan_q0, M_PI/2. - mScan_e0
                                      ,mScan_q0,M_PI/2.);
  ...
  delete []pwcharrColNames;
    ...
    mpSubWaterAnt->calcVectMeasures(mlamb,valSignalAmp, m_qu_True, m_e_True, arrQ );

   mpSubWaterAnt->calcAmpRaznMeth_e(mlamb,arrQ, mScan_q0, M_PI/2.- mScan_e0, &m_e_Zv);

    mpSubWaterAnt->calcAmpRaznMeth_q(mlamb,arrQ, mScan_q0, M_PI/2.- mScan_e0, &m_qu_Zv);
...
delete []pwcharrColNames;
  ...
  TComp arrQ[7];
  mpSubWaterAnt->calcVectMeasures(mlamb,1., 0., e, arrQ );
  double arrArg[7] ={0.};
  for (int i = 0; i< 7; ++i)
  {
