    ...
    ui(new Ui::MainWindow)
{
     ...
     this->ui->lineEdit_3->setText("D:/Proj_C++/AKIN/FILE48.000");
  ...
  ui->doubleSpinBox_14->setValue(6);
...
//!
     ...
     mTObrabotki = ui->doubleSpinBox_34->value() * 0.001;
...
void MainWindow::on_pushButton_3_clicked()
{
    ...
    case 1:
        mUsbl_2D_Solver = QUsbl_3D_Solver(parrMeas, mQuantMeas    ,mtblEstPrfl
                                ,marrGPSAprioriPosParams,marrTrueHeadLightPos[2]);
   ...
   // arrX0[5]= marrAprioriHeadLightPos[2];
    ...
    if(!mpPosSolver->estimateParams(arrX0,arrXRez, valNeviaz0))
    {
        int uu =0;
    }
...
void MainWindow::on_comboBox_4_currentIndexChanged(int index)
{
 switch(index)
 {
    ...
    case 3:
    case 4:
     ui->doubleSpinBox_14->setValue(index+3);
     ui->doubleSpinBox_14->setReadOnly(true);
     break;
    case 5:
...
void MainWindow::on_pushButton_5_clicked()
{
    ...
    QString strFold = QFileDialog::getOpenFileName(0,"Выбор .000 файла с профилем скорости","..//AKIN" ,"*.000");
