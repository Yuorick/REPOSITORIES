...
public:
  ...
  // enumTypeOfRLS mTypeOfRLS;
    ...
    // вектор систематических ошибок ИС
...
private slots:
    ...
    void onLBLTaskSucceeded( bool bbegin
    ...
    void onUSBLTaskSucceeded( bool bbegin
                            ,QVector<double>vct_arr_dX_po_dSgps
                            ,QVector<double>vct_arr_dX_po_dHBeacon
                            ,QVector<double>vct_arr_Kgps
                            ,QVector<double>vct_arr_Kt
