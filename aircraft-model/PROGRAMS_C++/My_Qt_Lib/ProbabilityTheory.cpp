...
//----------------------------------------------------------------------------------
// вычисление двойного иньтеграла от 2-х мероной плотности нормальеого распределения
// по кругу с центрлм в точке  (VAlX, VAlY) радиусом  VAlKillingRange
// VAlStepIntegr - шаг сетки интегрроования
// arrElK - корреляционная матрица
...
// дисперсия равномерного распределения на отрезке VAlL
