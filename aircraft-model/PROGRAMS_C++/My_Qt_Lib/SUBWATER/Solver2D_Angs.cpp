...
//--------------------------------------------------
void QSolver2D_Angs::calc_dAngs_po_dSgps(double *arrAngX0,double *arrMtrx_dFGr_po_dXang_Inv
                       , double *arr_dXpos_po_dSgps, QVector<double> *pvct_dAngs_po_dSgps)
{
    ...
    calc_dFusbl_po_dXlbl(arrAngX0, parrMtrx_dFGrA_po_dX0pos);
    // !
...
void QSolver2D_Angs::calc_dAngs_po_dHBeacon(double *arrAngX0,double *arrMtrx_dFGr_po_dXang_Inv
                                            , double *arr_dXpos_po_dH,QVector<double> &vct_dAngs_po_dH)
...
bool  QSolver2D_Angs:: calc_K_qe(double *arrAngX0,double *arrMtrx_dFGr_po_dXang_Inv,QVector<double> &vct_K_dqe)
{
    ...
    memset(parr_df_po_dqe, 0, QntMeas * mDimX* mDimY * sizeof(double));
...
bool  QSolver2D_Angs:: calc_dAngs_po_dAngSins(double* arrAngX0,double* arrMtrx_dFGr_po_dXang_Inv
                                              , double *arr_dXpos_po_dSins,QVector<double> &vct_dXa_po_AngSins)
{
