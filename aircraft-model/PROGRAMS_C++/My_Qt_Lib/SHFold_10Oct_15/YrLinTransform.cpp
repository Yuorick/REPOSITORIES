...
// x0, y0 - координаты точки (0,0) новой системы координат (СК)
// alf0 - угол  между осями 0X старой и новой СК
// исчисляется против часовой стрелки от 0X1 к 0X2
// x,y - координаты точки в старой СК
// xTr,  yTr  - координаты той же точки в новой СК
{
...
// вычисление угла между 2-мя векторами исходящими из начала координат
// угол исчисляется против часовой стрелкипо направлению от 1-го ко 2-му
{
