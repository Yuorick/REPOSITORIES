...
/*
bool  TURFigure::LoadFromStream(TStream *Stream)
{
...
bool  TURFigure::SaveToStream(TStream *Stream)
{
...
void  TURFigure::SwapInt(int &Data)
{
	unsigned char b ;
...
void  TURFigure::Draw(TCanvas *Canvas, bool bSelect)
{

}
//---------------------------------------------------------------------------

TURFigure*  TURFigure::PtInFigure(const TPointXY &pt)
{
return NULL ;
}
//---------------------------------------------------------------------------

TURFigure*  TURFigure::PtNearVisibleFigure(const TPointXY &pt)
{
return NULL ;
}
//---------------------------------------------------------------------------

double  TURFigure::GetArea()
{
return -1 ;
}
//---------------------------------------------------------------------------

double  TURFigure::GetLength()
{
return -1 ;
}
//---------------------------------------------------------------------------

int  TURFigure::GetSize()
{
return -1 ;
}
//---------------------------------------------------------------------------

void  TURFigure::SetOrgExt(const TPointXY &Offset, double kExt)
{
}
//---------------------------------------------------------------------------
 */
