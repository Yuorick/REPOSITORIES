...
public:
  ...
  //  bool calc_2D_arrNeviaz_and_dArrNeviaz_po_dX_old(double *arrX, QBigMeasure Meas, QDataExchange DataExchange
    ...
    //
    void calc_dAngs_po_dSgps(double *arrAngX0,double *arrMtrx_dFGr_po_dX_Inv, QVector<double> *pvct_dAngs_po_dSgps);
    ...
    bool  calc_arrdfiA_po_dXpos(double *arrX
     ...
     void calc_dAngs_po_dHBeacon(double *arrAngX0,double *arrMtrx_dFGr_po_dXang_Inv,QVector<double> &vct_dAngs_po_dH);
    ...
    bool  calc_dAngs_po_dAngSins(double* arrAngX0,double* arrMtrx_dFGr_po_dXang_Inv,QVector<double> &vct_dXa_po_AngSins);
   ...
   // bool  calc_arrdfiA_po_dAngSins(double *arrX
    ...
    bool  calc_dAngs_po_dProfile(double* arrAngX0,double* arrMtrx_dFGr_po_dXang_Inv,QVector<double> &vct_dAngs_po_dProfile);
